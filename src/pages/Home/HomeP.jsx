		...
		<div className="row align-items-center mb-5">
			<div className="col-lg-6 mb-4 mb-lg-0">
				<img
					src={image}
					alt={title}
					className="support-img img-fluid rounded shadow"
				/>
			</div>
					...
					<div className="features-grid">
						<div className="feature-item">
							...
							<p className="feature-description">
								Encontre oportunidades que se alinham com suas habilidades e
						...
						<div className="feature-item">
							...
							<p className="feature-description">
								Conectamos empresas com profissionais qualificados para um
